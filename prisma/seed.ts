...
const products = [
  {
    ...
    categorySlug: "women",
    description:
      "A structured wool coat with a clean single-breasted front, made for cold mornings and polished layering.",
    price: 189.0,
    previousPrice: 229.0,
  ...
  },
  {
    ...
    categorySlug: "women",
    description: "Crisp cotton poplin in an easy oversized cut that sharpens denim, tailoring, or soft separates.",
    price: 54.0,
    previousPrice: null,
  ...
  },
  {
    ...
    categorySlug: "women",
    description: "Fluid pleated trousers with a high rise and wide leg, balancing softness with tailored structure.",
    price: 79.0,
    previousPrice: 99.0,
  ...
  },
  {
    ...
    categorySlug: "women",
    description: "A refined blazer with gentle structure and an elongated line for smart office days and evening plans.",
    price: 129.0,
    previousPrice: null,
  ...
  },
  {
    ...
    categorySlug: "men",
    description: "A dense cotton crewneck that keeps its shape and delivers a premium feel in everyday rotation.",
    price: 35.0,
    previousPrice: null,
  ...
  },
  {
    ...
    categorySlug: "men",
    description: "Stretch-infused chinos with a neat taper and clean finish, built for workdays, travel, and weekends.",
    price: 68.0,
    previousPrice: 85.0,
  ...
  },
  {
    ...
    categorySlug: "men",
    description: "Fine merino knitwear with a smooth zip front, ideal for lightweight warmth and understated layering.",
    price: 92.0,
    previousPrice: null,
  ...
  },
  {
    ...
    description: "A compact leather crossbody with an adjustable strap and organized interior for daily essentials on the move.",
    price: 110.0,
    previousPrice: 140.0,
    modelSizeInfo: null,
    sizeChartJson: null,
